...
(defrecord IOAttackData [projection-sigma cumulative-noise-sigma knowns unknown]) ;; independent-sigma
...
(defn build-io-attack-data
  ...
  [projection-sigma cumulative-noise-sigma input-matrix masked-matrix ;;independent-sigma
